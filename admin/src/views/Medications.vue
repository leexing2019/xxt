...
const PINYIN_MAP: Record<string, string> = {
  ...
  '艺': 'y', '忆': 'y', '议': 'y', '异': 'y', '亦': 'y', '衣': 'y', '医': 'y',
  '依': 'y', '仪': 'y', '宜': 'y', '姨': 'y', '移': 'y', '遗': 'y', '疑': 'y',
  '乙': 'y', '已': 'y', '以': 'y', '蚁': 'y', '椅': 'y', '义': 'y', '艺': 'y',
  '忆': 'y', '议': 'y', '异': 'y', '亦': 'y', '因': 'y', '音': 'y', '阴': 'y',
